  ...
  for (const opportunity of byAsin.values()) {
    ...
    await db.adminArbitrageProduct.upsert({
      ...
      create: {
        ...
        amazonImageUrl: opportunity.amazon.imageUrl ?? null,
        amazonImageUrlsJson: JSON.stringify(
          opportunity.amazon.imageUrl ? [opportunity.amazon.imageUrl] : [],
        ),
        amazonInStock: true,
      ...
      update: {
        ...
        amazonShippingCents: opportunity.amazon.shippingCostCents,
        amazonUrl: opportunity.amazon.url,
        ...(opportunity.amazon.imageUrl && {
          amazonImageUrl: opportunity.amazon.imageUrl,
          amazonImageUrlsJson: JSON.stringify([opportunity.amazon.imageUrl]),
        }),
        amazonInStock: true,
        amazonRefreshedAt: new Date(),
        category: opportunity.category,
