...
export type PurchaseHistoryRow = { id: string; ebayOrderId: string; ebayTitle: string; amazonOrderId: string; amazonTitle: string; amazonUrl: string | null; purchasedAt: string | null; sourcingStatus: string; trackingNumber: string | null; revenueCents: number; ebayFeeCents: number; actualAmazonCostCents: number | null; estimatedAmazonCostCents: number; confidence: number | null };
